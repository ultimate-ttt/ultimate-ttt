...
import { circleFinishedBoardMock, movesForCircleFinishedBoardMock } from '../../__mocks__';
    ...
    const analysis = shallow(
      <AnalysisGameDisplay
        ...
        analysisGame={{
          ...
          activeBoards: [],
          currentMove: movesForCircleFinishedBoardMock[movesForCircleFinishedBoardMock.length - 1].moveNumber,
          game: {
